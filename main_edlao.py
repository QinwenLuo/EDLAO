...
from trainer.edlao_trainer import EDLAORayPPOTrainer


@hydra.main(
    config_path=os.path.join(os.path.dirname(__file__), "config"),
    config_name="edlao_trainer",
    version_base=None,
)
def main(config):
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            ...
            from workers.edlao_fsdp_workers import (
            ...
            if use_legacy_worker_impl in ["auto", "enable"]:
                ...
                from workers.edlao_fsdp_workers import CriticWorker
